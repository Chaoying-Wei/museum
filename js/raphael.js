...
(function() {
	...
	var bn = bm(function(a) {
		...
		bF = function(a) {
			return function() {
				throw new Error("Rapha毛l: you are calling to method 鈥�" + a + "鈥� of removed object")
			}
		};
	a.pathToRelative = bp;
	if(a.svg) {
		...
		k.clear = function() {
			...
			(this.desc = bG("desc"))[l](g.createTextNode("Created with Rapha毛l"));
			a[l](this.desc);
...
function sHover(f, e) {
	...
	for(var c = 0; c < d.length; c++) {
		...
		function a(j, k) {
			h.myAddEvent(j, "mouseover", function(l) {
				h.hoverIn(l, j, k)
			});
			h.myAddEvent(d[c], "mouseout", function(l) {
				h.hoverOut(l, j, k)
			})
		}
		a(b, g)
